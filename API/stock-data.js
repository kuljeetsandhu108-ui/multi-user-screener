// ===================================================================
// FINAL BACKEND with Correct Date Formatting
// ===================================================================
const { SmartAPI } = require("smartapi-javascript");
const { TOTP } = require("totp-generator");
const fetch = require('node-fetch');

// --- Technical Analysis Calculation Functions (Unchanged) ---
...
module.exports = async function handler(request, response) {
    ...
    try {
        ...
        // --- THE FIX IS HERE: Add time component to the date strings ---
        const toDate = new Date();
        const fromDate = new Date(toDate.getTime() - (100 * 24 * 60 * 60 * 1000)); // Approx 100 days ago
        const toDateStr = `${toDate.getFullYear()}-${String(toDate.getMonth() + 1).padStart(2, '0')}-${String(toDate.getDate()).padStart(2, '0')} 15:30`;
