...
// This function is SLOWER. It only gets advanced analysis data.
// ===================================================================
...
module.exports = async (request, response) => {
    try {
        ...
        const [historyRes, finnhubMetricsRes, finnhubFinancialsRes, finnhubOwnershipRes] = await Promise.allSettled([
            // We need a logged-in session to get history, so we must log in again here.
            (async () => {
        ...
        const responseData = { rsi, ema20, ema50, recommendation, piotroskiFScore, grahamScanPassed, fiiPercentage };
        
        response.setHeader('Cache-Control', 's-maxage=300, stale-while-revalidate'); // Longer cache for analysis data
